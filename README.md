...
FRR-маршрутизаторы и виртуальные ПК, выбирает порты при соединении, запускает
узлы и открывает веб-консоли. Реализованы редактирование, перезагрузка, сброс,
экспорт и повторное применение конфигураций, а также захват пакетов. Готовых
схем, адресов и настроенных протоколов нет.
...
Постраничная сверка с заданием и точные границы соответствия:
[docs/LOGIC_AUDIT.md](docs/LOGIC_AUDIT.md).
